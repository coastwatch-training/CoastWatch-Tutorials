...
`
**Note** The metadata states that the _FillValue for this dataset is set to -999, however.when the _FillValue attribute is found, the ncdf4 package maps all the missing value (_FillValue) to NA's.  
