...
* Region boundaries: 30.86 to 41.75 north latitude and -128 to -116 east longitude  
...
Since buoy data are hourly and satellite data are daily, buoy data needs to be subsetted to the time coverage that corresponds to the time the satellite passes overhead (22h00 GMT (2pm local + 8).
...
1. get coordinates from buoy data
2. using rxtracto function and the coordinates from buoy data, subset satellite data
