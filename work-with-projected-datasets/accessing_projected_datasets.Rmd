---
title: Accessing projected datasets
...
[R Tutorial: Making Projected Plots with Lat-Lon Datasets](https://github.com/CoastWatch-WestCoast/r_code/blob/master/reprojecting_satellite_buoy_data.md) - An R notebook tutorial that demonstrates how to access traditional lat-lon datasets from ERDDAP and make plots of the data in projections that are common to the polar regions and Alaska.

[ERDDAP Tutorial](https://github.com/CoastWatch-WestCoast/ERDDAP-basics) - An introduction to using ERDDAP for viewing and downloading data.
