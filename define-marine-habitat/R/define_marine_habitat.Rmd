...
* Using the _xtracto_3D_ function to extract data from a rectangular area  
...
__ Set the temperature band to 17.5-18.5 degrees C, as determined by the TurtleWatch program.__  
...
It would be nicer to color in the TurtleWatch band (the NA values) with a different color. If you want to customize graphs it's better to use `ggplot` than the `plotBBox` that comes with the
